...
class EnhancedSeasonalColorModel:
    ...
    def train_model(self, train_path, val_path=None, model_params=None, save_name=""):
        ...
        # Prepare features
        X_train = df.drop(['image_file','season'], axis=1)
        y_train = df['season']
    ...
    def eval_model(self, test_path, results_folder=None):
        ...
        X_test = df.drop(['image_file','season'], axis=1)
        y_test = df['season']
